...
- Choose pointings to do manually. (object in header contains the pointing number also
printed in the opening of file in astrom.py.)
- Open the cutout and exposure in ds9 follow manual instructions using
manualds9adjusts.py to adjust the images until happy with alignment
